  ...
  return <>
    ...
    <main>
      <section className="hero reveal">
        <div className="heroCopy"><p className="heroEyebrow">MATERIAL DIGITAL • ACESSO IMEDIATO</p><h1 aria-label="+200 Receitas de Doces Personalizados para criar doces mais bonitos e valorizar cada encomenda"><span className="headlineDesktop" aria-hidden="true"><span className="heroHighlight">+200 Receitas de Doces Personalizados para criar</span><span>doces mais bonitos e valorizar cada encomenda</span></span><span className="headlineMobile" aria-hidden="true"><span className="heroHighlight">+200 Receitas de Doces Personalizados para criar</span><span>doces mais bonitos e valorizar cada encomenda</span></span></h1><p className="lead">Tenha centenas de receitas e ideias visuais reunidas em um só lugar para consultar quando precisar, descobrir novos doces e levar muito mais variedade para suas encomendas.</p></div>
